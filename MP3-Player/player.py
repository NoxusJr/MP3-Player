...
organise_menu.add_command(label='Selecionar Pasta', command=load_music)
organise_menu.add_command(label='Selecionar Música', command=load_individual)
menubar.add_cascade(label='Procurar', menu=organise_menu)

songlist = Listbox(root, bg="black", fg="white", width=100, height=22)
songlist.pack()
